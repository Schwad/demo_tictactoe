class TicTacToeController < ApplicationController
  ...
  def make_move
    ...
    @board_arr = Board.new(retrieve_board_arr)
    @board_arr.add_piece(retrieve_coords, @current_player)
    #TODO: add logic here to play the turn
    @board_arr = @board_arr.board_arr
    if @board_arr.winning_combination?(@current_player)
